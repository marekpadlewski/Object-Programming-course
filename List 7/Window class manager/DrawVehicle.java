...
public class DrawVehicle extends JPanel {
    ...
    private String filename = "VehFile.bin";

    private File file = new File(filename);


    public DrawVehicle(JFrame f){
        frame = f;
    }
    ...
    public void paintComponent(Graphics g){
        ...
        button2.addActionListener(e -> {
            ...
            try {
                if (!file.exists()){
                    AddVehicle.vehicles.add(new Vehicle());
                }

                else {
                    ObjectInputStream is = new ObjectInputStream(new FileInputStream(filename));
                    Vehicle v = (Vehicle) is.readObject();
                    AddVehicle.vehicles.add(v);
        ...
        button3.addActionListener(e -> {
            ...
            try {
                ...
                os.writeObject(AddVehicle.vehicles.get(AddVehicle.vehicles.size()-1));
                os.close();
